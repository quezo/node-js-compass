...
describe('scss', function() {
  describe('import', function() {
    it('should xxx', function(done) {
      new Scss(
        fs.readFileSync(path.join(__dirname, './engine/import.scss'), {
          encoding: 'utf8'
        }), {
  ...
  describe('nested import', function() {
    it('should xxx', function(done) {
      new Scss(
        fs.readFileSync(path.join(__dirname, './engine/nested-import.scss'), {
          encoding: 'utf8'
        }), {
          includePaths: [path.join(__dirname, './engine')]
        }
  ...
  describe('variables', function() {
    it('should xxx', function(done) {
      new Scss(
        fs.readFileSync(path.join(__dirname, './engine/interpolated-variables.scss'), {
          encoding: 'utf8'
        }), {
          includePaths: [path.join(__dirname, './engine')],
          functions: {
  ...
  describe('custom function', function() {
    it('should xxx', function(done) {
      new Scss(
        fs.readFileSync(path.join(__dirname, './engine/custom-function.scss'), {
          encoding: 'utf8'
        }), {
          includePaths: [path.join(__dirname, './engine')],
          functions: {
  ...
  describe('mixin', function() {
    ...
    it('should xxx', function(done) {
      new Scss(
        fs.readFileSync(path.join(__dirname, './engine/mixin.scss'), {
          encoding: 'utf8'
        }), {
          includePaths: [path.join(__dirname, './engine')]
        }
